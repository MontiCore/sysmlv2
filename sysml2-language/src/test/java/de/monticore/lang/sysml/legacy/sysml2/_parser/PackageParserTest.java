...
public class PackageParserTest {
  ...
  public void testComment() {
    ...
    Path model = Paths.get("src/test/resources/sysml2/parser/01.Packages/Comment Example.sysml");
  ...
  public void testPackage() {
    SysML2Parser parser = new SysML2Parser();
    Path model = Paths.get("src/test/resources/sysml2/parser/01.Packages/Package Example.sysml");
