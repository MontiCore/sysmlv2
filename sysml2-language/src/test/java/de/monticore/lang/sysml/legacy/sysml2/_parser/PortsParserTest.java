...
public class PortsParserTest {
  
  @Ignore
  @Test
  public void testPortConjugation() {
    SysML2Parser parser = new SysML2Parser();
    Path model = Paths.get("src/test/resources/sysml2/parser/08.Ports/Port Conjugation Example.sysml");
  ...
  @Ignore
  @Test
  public void testPartsPort() {
    SysML2Parser parser = new SysML2Parser();
    Path model = Paths.get("src/test/resources/sysml2/parser/08.Ports/Port Example.sysml");
