...
import de.monticore.lang.sysmlparts._symboltable.OccurrenceDefSymbol;
import de.monticore.symbols.basicsymbols._symboltable.IBasicSymbolsScope;
import de.monticore.symbols.basicsymbols._symboltable.TypeSymbol;
import de.se_rwth.commons.SourcePosition;

public class OccurrenceDef2TypeSymbolAdapter extends TypeSymbol {
  protected OccurrenceDefSymbol adaptee;

  public OccurrenceDef2TypeSymbolAdapter(OccurrenceDefSymbol adaptee) {
    super(Preconditions.checkNotNull(adaptee.getName()));
    this.adaptee = adaptee;
  }

  protected OccurrenceDefSymbol getAdaptee() {
    return adaptee;
  }
