...
public class VariableValueWrapper implements ASTVariableValue {
  private final ASTExpression value;

  private final VariableSymbol variable;

  VariableValueWrapper(VariableSymbol variable, ASTExpression value) {
    this.value = value;
    this.variable = variable;
  }

  @Override public ASTExpression getValue() {
    return value;
  }

  @Override
  public String getVariable() {
    return getVariableSymbol().getName();
  }
  ...
  @Override
  public ASTVariable getVariableDefinition() {
    return null;
  }

  @Override
  public boolean isPresentVariableDefinition() {
    return false;
  }
  ...
  @Override
  public ASTVariableValue deepClone() {
    return null;
  }
