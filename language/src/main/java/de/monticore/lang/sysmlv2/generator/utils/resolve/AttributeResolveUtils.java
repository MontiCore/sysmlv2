...
public class AttributeResolveUtils {
  static public List<ASTAttributeUsage> getAttributesOfElement(ASTSysMLElement node) {
  ...
  static List<ASTAttributeUsage> getAttributeUsageOfNode(ASTSysMLElement node) {
