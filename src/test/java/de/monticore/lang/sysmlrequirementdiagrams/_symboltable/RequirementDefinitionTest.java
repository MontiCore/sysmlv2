...
import de.monticore.lang.sysmlparametrics._symboltable.SysMLParametricsScopesGenitor;
...
public class RequirementDefinitionTest {
  ...
  @Ignore
  @Test
  public void testNestedScopes_Error() throws IOException {
    /*
     ...
     */
    testScopeNesting("src/test/resources/sysmlrequirementdiagrams/_symboltable/RequirementDefinitionSymbol_Error.sysml");
  }
