...
public enum SysMLCoCoName {
  ...
  ,PortDirection, NameReference, UniqueName, ImportIsDefined, PackageImportWithoutStar,
  AmbiguousImport, ImportedElementNameAlreadyExists, DoubleImportOfDifferentSymbolsSameName
}
